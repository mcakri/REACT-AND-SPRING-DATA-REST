...
module "iam_dev-group-with-assumable-roles-policy" {
  ...
  version         = "3.6.0"
  name            = "developer"
  group_users     = [module.iam_dev_user1.this_iam_user_name, module.iam_dev_user2.this_iam_user_name]
...
module "iam_tester-group-with-assumable-roles-policy" {
  ...
  version         = "3.6.0"
  name            = "tester"
  group_users     = [module.iam_tester_user1.this_iam_user_name, module.iam_tester_user2.this_iam_user_name]
