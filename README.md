...
\$ curl -v -u greg:turnquist 0.0.0.0:8080/api/employees/1
{
"firstName" : "Frodo",
"lastName" : "Baggins",
...
"\_links" : {
"self" : {
"href" : "http://0.0.0.0:8080/api/employees/1"
}
}
}
...
To see the frontend, navigate to http://0.0.0.0:8080. You are immediately redirected to a login form. Log in as `greg/turnquist`
